...
export const outils = [
  ...
  },
  {
    ...
    arbitrage:
      "Ce qui manquait n’était pas un support mais un moment et un responsable : un instant de la journée où les tâches sont nommées et attribuées à quelqu’un. C’est cette décision-là qui règle le problème. Restait qu’aucun responsable n’allait consolider quatre sources d’information à la main chaque matin — c’est ce qui a rendu le support nécessaire.",
    action:
  ...
  },
  {
    ...
    context:
      "Ces tâches s’appuyaient sur des documents dispersés, des calculs refaits à la main et les mêmes informations ressaisies chaque fois. Isolées, elles paraissent mineures ; répétées, elles consomment du temps de vente et laissent passer des erreurs.",
    arbitrage:
